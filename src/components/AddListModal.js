  ...
  render() {
    ...
    return (
      <Modal isOpen={isOpen} toggle={toggleModal}>
        ...
        <ModalBody>
          <Input id='form-input-control-title' name='title'
        ...
        <ModalFooter>
          ...
          <Button onClick={e => {addList({id: v4(), tasks: [], title: this.state.title});toggleModal();this.setState({title: ''})}} positive content='Add new list'/>
        </ModalFooter>
      </Modal>
    )
  }
