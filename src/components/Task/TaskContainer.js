...
class TaskContainer extends Component {
	...
	checkIfTaskCompleted() {
		...
		if (date > taskDate && !this.props.taskData.isChecked) {
		...
		return (
			...
			>
				{isEditable ? (
					...
					<Task editTask={this.editTask} deleteTask={this.deleteTask} taskData={this.props.taskData} />
				)}
			</article>
		);
	}
