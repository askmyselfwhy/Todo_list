...
const Task = (props) => {
	...
	return (
		<div>
			{priority > 0 ? <Rating icon="star" disabled maxRating={priority} defaultRating={priority} /> : ''}
			<div className="list__task-content">
				<p className="list__task__caption">
					{isChecked ? <Icon name="check square outline" /> : <Icon name="square outline" />}
					{caption}
				</p>
				<div className="list__task-controls">
					<Button compact size="mini" color="teal" content="Edit" onClick={(e) => editTask(e)} />
