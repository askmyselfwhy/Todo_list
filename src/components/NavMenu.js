...
class NavMenu extends Component {
  ...
  render() {
    let {sortAsc, deleteAllCheckedTasks,toggleSortAsc} = this.props
    ...
    return (
      <Menu as='nav' stackable >
        ...
        <Popup flowing
          ...
          trigger={<Menu.Item><Icon name='add'/>Add new task</Menu.Item>}
          on='click' hideOnScroll>
          <AddTaskForm handleChanges={handleChanges} onAddTask={onAddTask}
            endDate={endDate} 
            priority={priority} 
            text={text}
